...
class Rating {
  ...
  class Product {
    ...
    showProductDetailsRecursion(object){
        let productDetails = "";

        console.log(object);
        for (const property in object) {
            if (typeof this[property] === "object") {
                showProductDetailsRecursion(property);
            }
            else {
                productDetails += `${property}: ${object[property]}, `;
            }
            } 
        return productDetails;
        }   
  ...
  (async () => {
   ...
   console.log(obj1.showProductDetailsRecursion(obj1));
  })();
